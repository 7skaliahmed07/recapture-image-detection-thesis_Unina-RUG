# Pipeline Summary - Combined Datasets
...
- **hyperparameters**: {'learning_rate': 0.0001, 'batch_size': 16, 'optimizer': 'Adam', 'epochs': 8, 'n_folds': 3, 'dropout_rate': 0.4, 'large_size': 256, 'repeat_factor': 4, 'num_test_patches': 5, 'datasets': ['NTU-Roselab-Dataset', 'Devices (5 mobiles)']}
